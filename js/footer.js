...
'</div>'+
'<div class="col-sm-12 d-flex align-items-center justify-content-center col-md-4 " id="helloda">'+
    '<nav class="navbar">'+
...
'<div class="bajo col-md-12">'+
    ...
    '<p class="d-flex text-white justify-content-center textohola">Proyecto de clase hecho con mucho amor y cariño ❤ por Kaiet, Aitor, Kevin y Aimar.R</p>'+
'</div>'+
'</div>'+
